...
def mnist_noniid(dataset, alpha, num_users):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param alpha: for dirichlet distribution
    :param num_users:
    :return:
    """
    ...
    class_idcs = [np.argwhere(train_labels[train_idcs]==y).flatten() for y in range(num_classes)]
    ...
    dict_users = {i: client_idcs[i] for i in range(num_users)}
